...
$drives = Get-CimInstance Win32_LogicalDisk | Where-Object DriveType -eq 3 | Where-Object DeviceID –ne "P:" | Select-Object -ExpandProperty DeviceID
$i = 0
...
If ($i -ge 1) { Write-Output "Vulnerable" }
